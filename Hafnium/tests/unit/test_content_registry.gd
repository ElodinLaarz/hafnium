...
func test_require_character_returns_wizard_definition() -> void:
	var wizard: Variant = ContentRegistry.require_character("class:wizard")
...
func test_legacy_class_lookup_uses_resource_registry() -> void:
	var wizard: Variant = ContentRegistry.require_legacy_character(ClassHandler.ClassName.WIZARD)
...
func test_require_enemy_returns_loot_enabled_definition() -> void:
	var slime: Variant = ContentRegistry.require_enemy("enemy:slime_basic")
