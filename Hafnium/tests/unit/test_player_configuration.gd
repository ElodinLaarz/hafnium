...
func test_lookup_character_wizard() -> void:
	var pcm: PlayerConfigurationManager = PLAYER_CONFIGURATION_MANAGER_SCRIPT.new()
	var config: PlayerConfigurationManager.PlayerConfiguration = pcm.lookup_character("wizard")
...
func test_lookup_character_druid() -> void:
	var pcm: PlayerConfigurationManager = PLAYER_CONFIGURATION_MANAGER_SCRIPT.new()
	var config: PlayerConfigurationManager.PlayerConfiguration = pcm.lookup_character("druid")
...
func test_lookup_character_unknown() -> void:
	var pcm: PlayerConfigurationManager = PLAYER_CONFIGURATION_MANAGER_SCRIPT.new()
	var config: PlayerConfigurationManager.PlayerConfiguration = pcm.lookup_character("nonexistent")
