...
var graph_generator: RoomGraphGenerator = ROOM_GRAPH_GENERATOR_SCRIPT.new()
...
func instantiate_room(room_id: String) -> Node2D:
	var room_data: RoomData = ContentRegistry.require_room(room_id)
